...
user_proxy.register_for_execution(name = "get_express_information")(get_express_information)

# chat_result = user_proxy.initiate_chat(class_assistant, message="请你告诉我讲真这门课的上课时间和下课时间")

group_chat = GroupChat(agents=[user_proxy, class_assistant, express_assistant], messages=[], max_round=120, speaker_selection_method="auto")
...
user_proxy.initiate_chat(group_manager, message="请你告诉我快递信息")
