# -*- coding: utf-8 -*-
# @Time : 2024/12/25 14:32
# @Author : lijinze
# @Email : lijinze@lzzg365.cn
# @File : multi_agent_practice.py
...
group_chat = GroupChat(agents=[class_assistant, express_assistant, user_proxy], messages=[], max_round=120, speaker_selection_method="auto")
